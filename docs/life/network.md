...
每一位在校生都可以获得一个@zju.edu.cn的教育邮箱，邮件系统的登陆账号和密码与上网账户相同（也就是连接ZJU-WLAN的密码，上网账户密码初始状态下与通行证密码也相同）。2021级及以后的本科生毕业后浙大邮箱将会被收回。

如何更好的使用浙大邮箱可以参考 [学习->邮件系统](../learning/email_etiquette.md)
